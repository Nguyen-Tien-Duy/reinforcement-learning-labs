...
model = d3rlpy.load_learnable("d3rlpy_logs/DiscreteBCQ_V6_20260418_0047_20260418004757/model_500000.d3", device="cuda:0")
...
while not done:
    ...
    steps += 1
t1 = time.time()
print(f"1 Episode on GPU ({steps} steps) took {t1-t0:.4f} seconds")
