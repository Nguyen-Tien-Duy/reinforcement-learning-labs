...
\textbf{Kết luận chính:} Mô hình Discrete CQL kết hợp Safety Layer 20\% đạt hiệu năng vượt trội, tiết kiệm \textbf{11.1\% chi phí Gas} so với chiến lược Greedy truyền thống mà vẫn đảm bảo an toàn tuyệt đối (\textbf{0\% Deadline Miss}). Mức tiết kiệm này tương đương với việc khai thác được 28.6\% tiềm năng tối đa của Oracle trong điều kiện không có thông tin tương lai.
